...
class AppSize {
  ...
  static double padding60(context) => width(context) * .22;
  ...
  static double padding6(context) => width(context) * .066;
  ...
  static double margin3(context) => width(context) * .03;
  ...
  static spaceHeight13(context) => SizedBox(height: height(context) * 0.015);
  ...
  static spaceHeight11(context) => SizedBox(height: height(context) * .10);
...
//===============width==========================================================
  ...
  static height50(context) => height(context) * .46;
  ...
  static height08(context) => height(context) * .08;
  ...
  static double textS26(context) => width(context) * .06;

  static double textS18(context) => width(context) * .04;

  static double textS16(context) => width(context) * .035;
  static double textS08(context) => width(context) * .029;
  static double textS07(context) => width(context) * .027;
  static double textS09(context) => width(context) * .030;

  static double textS14(context) => width(context) * .031;
  static double textS15(context) => width(context) * .033;
  static double textS10(context) => width(context) * .026;
